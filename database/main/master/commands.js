...
// CoinGecko Table Commands
const CoinChanges = require('./coin/changes');
...
const Commands = function (logger, client, configMain) {
  ...
  // Initialize Coin Commands
  this.coin.changes = new CoinChanges(_this.logger, _this.configMain);
  this.coin.prices = new CoinPrices(_this.logger, _this.configMain);
