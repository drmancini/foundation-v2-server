...
describe('Test payments functionality', () => {
  ...
  test('Test initialization of payments', () => {
    ...
    expect(typeof payments.handleCurrentBalances).toBe('function');
  });
  ...
  test('Test payments database updates [3]', () => {
    ...
    expect(payments.handleCurrentBalances(amounts, balances, 'primary')).toStrictEqual(expected);
  });
  ...
  test('Test payments main updates [1]', (done) => {
    ...
    const expectedGenerateBlocksDeletes = `
      ...
      WHERE round IN ('round1', 'round2', 'round3', 'round4', 'round5', 'round6');`;
    const expectedResetBalances = `
      UPDATE "Pool-Bitcoin".current_balances
    ...
    const expectedBalances = `
      ...
      DO UPDATE SET
        ...
        paid = "Pool-Bitcoin".current_balances.paid + EXCLUDED.paid;`;
    ...
    client.on('transaction', (transaction) => {
      ...
      expect(transaction[2]).toBe(expectedResetBalances);
      ...
      expect(transaction[8]).toBe(expectedTransactionsDelete);
      done();
    });
  ...
  test('Test payments main updates [2]', (done) => {
    ...
    client.on('transaction', (transaction) => {
      ...
      expect(transaction[1]).toBe(expectedResetBalances);
      done();
    });
